...
public class GrailsTestAppMojo extends AbstractGrailsMojo {
    ...
    /**
     * Allows setting of path to AspectJ load-time-weaver agenet jar.
     *
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        if (weaveAgentPath != null) {
            ...
            envVars.put("GRAILS_OPTS","-Dorg.aspectj.weaver.showWeaveInfo=true -javaagent:"+weaveAgentPath+" -Xms512m -Xmx1480m -XX:PermSize=256m -XX:MaxPermSize=768m");
        }
